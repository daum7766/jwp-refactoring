...
INSERT INTO productDto (id, name, price) VALUES (1, '후라이드', 16000);
INSERT INTO productDto (id, name, price) VALUES (2, '양념치킨', 16000);
INSERT INTO productDto (id, name, price) VALUES (3, '반반치킨', 16000);
INSERT INTO productDto (id, name, price) VALUES (4, '통구이', 16000);
INSERT INTO productDto (id, name, price) VALUES (5, '간장치킨', 17000);
INSERT INTO productDto (id, name, price) VALUES (6, '순살치킨', 17000);

INSERT INTO menuDto (id, name, price, menu_group_id) VALUES (1, '후라이드치킨', 16000, 2);
INSERT INTO menuDto (id, name, price, menu_group_id) VALUES (2, '양념치킨', 16000, 2);
INSERT INTO menuDto (id, name, price, menu_group_id) VALUES (3, '반반치킨', 16000, 2);
INSERT INTO menuDto (id, name, price, menu_group_id) VALUES (4, '통구이', 16000, 2);
INSERT INTO menuDto (id, name, price, menu_group_id) VALUES (5, '간장치킨', 17000, 2);
INSERT INTO menuDto (id, name, price, menu_group_id) VALUES (6, '순살치킨', 17000, 2);
